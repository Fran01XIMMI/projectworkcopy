...
<head>
    ...
    <title>SecureBank Admin - Login</title>
    <style>
        {{ css }}
    </style>
...
def dashboard():
    ...
    <body>
        ...
        <nav class="main-nav">
            <ul>
                ...
                <li><a href="{{ url_for('predict') }}"><i class="fas fa-chart-line"></i> Prediction Report</a></li>
            </ul>
        </nav>
            ...
            <div class="dashboard-stats">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3>Accounts</h3>
                        <p class="stat-number">{{num_clienti}}</p>
    ...
    return render_template_string(dashboard_template, css=css,
                                  ...
                                  role=session['role'], num_clienti=num_clienti)
        ...
        <main class="main-content dashboard">
            ...
            <form action="/search_result" method="get">
                ...
                <div class="container">
                    <div class="col">
                        <button type="submit">
                        <a href="/result_search_client" class="btn btn-primary">View Results</a>
                        </button>
                    </div>
                </div>
            </form>
...
@app.route('/result_search_client')
@login_required
def result_search_client():
    ...
    try:
        ...
        if age_type == 'single' and age:
            ...
            # Analizza l'intervallo di età
            if age_range == '90+':
                min_age = 90
                max_age = 150  # Assumiamo che nessuno sia più vecchio di 150 anni
            else:
...
def predict():
    ...
    if request.method == 'POST':
        ...
        # Ensure all columns match the trained model's columns
    ...
    <body>
        ...
        <nav class="main-nav">
            <ul>
                ...
                <li><a href="{{ url_for('delete_client') }}"><i class="fas fa-user-minus"></i> Delete Client</a></li>
                <li><a href="{{ url_for('search_client') }}"><i class="fas fa-users"></i> Search Clients</a></li>
                <li class="active"><a href="{{ url_for('predict') }}"><i class="fas fa-chart-line"></i> Prediction Report</a></li>
            </ul>
        </nav>
